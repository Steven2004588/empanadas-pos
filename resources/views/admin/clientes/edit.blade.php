...
<div class="d-flex align-items-center mb-4">
    ...
    <h4 class="mb-0"><i class="bi bi-person-gear"></i> Editar Cliente</h4>
</div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select name="tipo_documento" class="form-select @error('tipo_documento') is-invalid @enderror">
                        ...
                        <option value="tarjeta_identidad"{{ old('tipo_documento', $cliente->tipo_documento) == 'tarjeta_identidad'? 'selected' : '' }}>Tarjeta de Identidad</option>
...
```
https://super-umbrella-pjq5w49xwpgwhr95v-8000.app.github.dev/admin/clientes